...
export class GateExchange extends BaseExchange {
	readonly exchangeId = Exchange.Gate
	readonly settlementHours = SETTLEMENT_HOURS[Exchange.Gate]

	private readonly exchange: InstanceType<typeof ccxt.pro.gate>
	...
	constructor() {
		super()
		this.exchange = new ccxt.pro.gate({ enableRateLimit: true, timeout: 15000 })
	}
