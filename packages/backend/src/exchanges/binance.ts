...
/**
 * Binance exchange adapter using CCXT Pro.
 *
...
export class BinanceExchange extends BaseExchange {
	...
	readonly settlementHours = SETTLEMENT_HOURS[Exchange.Binance]

	private readonly exchange: InstanceType<typeof ccxt.pro.binance>
	...
	constructor() {
		super()
		this.exchange = new ccxt.pro.binance({ enableRateLimit: true, timeout: 15000 })
	}
