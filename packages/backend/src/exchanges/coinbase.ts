...
export class CoinbaseExchange extends BaseExchange {
	readonly exchangeId = Exchange.Coinbase
	readonly settlementHours = SETTLEMENT_HOURS[Exchange.Coinbase]

	private readonly exchange: InstanceType<typeof ccxt.pro.coinbase>
	...
	constructor() {
		super()
		this.exchange = new ccxt.pro.coinbase({ enableRateLimit: true, timeout: 15000 })
	}
