...
export class BitgetExchange extends BaseExchange {
	readonly exchangeId = Exchange.Bitget
	readonly settlementHours = SETTLEMENT_HOURS[Exchange.Bitget]

	private readonly exchange: InstanceType<typeof ccxt.pro.bitget>
	...
	constructor() {
		super()
		this.exchange = new ccxt.pro.bitget({ enableRateLimit: true, timeout: 15000 })
	}
